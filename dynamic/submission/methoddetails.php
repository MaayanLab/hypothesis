...
<form>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="colab" placeholder="URL" value="https://colab.research.google.com/drive/1W8_4dq_lyARjo0icVHJDgliHyZdnjViD">
    </div>
  </div>
...
<div class="row">
    <div class="col-12 text-right">
        <br>
        <button class="btn btn-secondary" type="button" data-dismiss="modal" onclick="clearMethodForm()">Cancel</button>
        <a class="btn btn-primary" href="javascript:createmethod();">Create Method</a>
    </div>
</div>
